        ...
        let index = if let Some(expr) = &self.index {
            ...
            quote! {
                std::fs::write(
                    ...
                    r#"<!DOCTYPE html><html><head><meta charset="utf-8"/><script type="module">import init from "/web_app.js";init(new URL('web_app_bg.wasm', import.meta.url));</script></head><body></body></html>"#,
                );
            }
        };
